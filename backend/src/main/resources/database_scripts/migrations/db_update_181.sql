...
alter table audit_action add column project_id uuid null after pk;
alter table dataset add column project_id uuid null after pk;
alter table dataset_audit add column project_id uuid null after pk;
alter table event add column project_id uuid null after pk;
alter table event_audit add column project_id uuid null after pk;
alter table field add column project_id uuid null after pk;
alter table field_audit add column project_id uuid null after pk;
alter table file add column project_id uuid null after pk;
alter table form add column project_id uuid null after pk;
alter table form_audit add column project_id uuid null after pk;
alter table internal_patch add column project_id uuid null first;
alter table mail add column project_id uuid null after pk;
alter table mail_attachment add column project_id uuid null after pk;
alter table payment add column project_id uuid null after pk;
alter table payment_batch add column project_id uuid null after pk;
alter table payment_target add column project_id uuid null after pk;
alter table resource add column project_id uuid null after pk;
alter table robot add column project_id uuid null after pk;
alter table robot_audit add column project_id uuid null after pk;
alter table role add column project_id uuid null after pk;
alter table role_audit add column project_id uuid null after pk;
alter table scope add column project_id uuid null after pk;
alter table scope_audit add column project_id uuid null after pk;
alter table scope_relation add column project_id uuid null after pk;
alter table workflow_status add column project_id uuid null after pk;
alter table workflow_status_audit add column project_id uuid null after pk;
