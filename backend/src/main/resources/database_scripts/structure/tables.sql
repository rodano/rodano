...
create table if not exists form_cell_visibility_criteria_value (
    ...
    constraint pk_form_cell_visibility_criteria_value primary key (project_id, form_layout_cell_id, form_cell_visible_criteria_id, line_order)
) engine = InnoDB default charset = utf8mb4 collate = utf8mb4_unicode_ci;
...
create table chart (
    ...
    project_id uuid not null,
    code varchar(128) not null,
    type enum ('ENROLLMENT_BY_SCOPE', 'ENROLLMENT', 'STATISTICS', 'WORKFLOW_STATUS') not null,
...
create table if not exists menu_layout_section_widget_parameter (
    ...
    width int null,
	display_add_response boolean null,
	remove_profile_selector boolean null,
	overdue_type varchar(128) null,
	specific_column_name varchar(128) null,
    scope_model_id uuid null,
