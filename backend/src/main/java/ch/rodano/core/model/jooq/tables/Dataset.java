...
public class Dataset extends TableImpl<DatasetRecord> {
	...
	/**
	 * The column <code>dataset.removed</code>.
	 */
	public final TableField<DatasetRecord, Boolean> REMOVED = createField(DSL.name("removed"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.BOOLEAN)), this, "");
