...
public class UserRecord extends UpdatableRecordImpl<UserRecord> {
	...
	/**
	 * Setter for <code>user.is_superuser</code>.
	 */
	...
	/**
	 * Getter for <code>user.is_superuser</code>.
	 */
