...
public class Keys {
	...
	public static final UniqueKey<UserSessionRecord> KEY_USER_SESSION_IDX_USER_SESSION_TOKEN = Internal.createUniqueKey(UserSession.USER_SESSION, DSL.name("KEY_user_session_idx_user_session_token"), new TableField[] { UserSession.USER_SESSION.TOKEN }, true);
