...
public class Robot extends TableImpl<RobotRecord> {
	...
	public List<Index> getIndexes() {
		return Arrays.asList(Indexes.ROBOT_IDX_ROBOT_DELETED, Indexes.ROBOT_IDX_ROBOT_PROJECT);
	}
	...
	@Override
	public List<ForeignKey<RobotRecord, ?>> getReferences() {
		return Arrays.asList(Keys.FK_ROBOT_PROJECT);
	}
	...
	public ProjectPath project() {
		if (_project == null)
			_project = new ProjectPath(this, Keys.FK_ROBOT_PROJECT, null);
