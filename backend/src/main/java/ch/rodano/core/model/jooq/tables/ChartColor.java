...
public class ChartColor extends TableImpl<ChartColorRecord> {
	...
	/**
	 * The column <code>chart_color.project_id</code>.
	 */
	public final TableField<ChartColorRecord, UUID> PROJECT_ID = createField(DSL.name("project_id"), SQLDataType.UUID.nullable(false), this, "");

	/**
	 * The column <code>chart_color.chart_id</code>.
	 */
	public final TableField<ChartColorRecord, UUID> CHART_ID = createField(DSL.name("chart_id"), SQLDataType.UUID.nullable(false), this, "");
	...
	/**
	 * The column <code>chart_color.sort_order</code>.
	 */
	public final TableField<ChartColorRecord, Integer> SORT_ORDER = createField(DSL.name("sort_order"), SQLDataType.INTEGER.nullable(false), this, "");
