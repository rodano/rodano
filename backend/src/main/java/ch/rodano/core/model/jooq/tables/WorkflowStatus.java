...
public class WorkflowStatus extends TableImpl<WorkflowStatusRecord> {
	...
	public List<Index> getIndexes() {
		return Arrays.asList(Indexes.WORKFLOW_STATUS_AGGREGATE_EVENT, Indexes.WORKFLOW_STATUS_AGGREGATE_SCOPE, Indexes.WORKFLOW_STATUS_IDX_WF_STATUS_EVENT_FK, Indexes.WORKFLOW_STATUS_IDX_WF_STATUS_FIELD_FK, Indexes.WORKFLOW_STATUS_IDX_WF_STATUS_FORM_FK, Indexes.WORKFLOW_STATUS_IDX_WF_STATUS_SCOPE_FK, Indexes.WORKFLOW_STATUS_IDX_WORKFLOW_STATUS_DELETED, Indexes.WORKFLOW_STATUS_IDX_WORKFLOW_STATUS_STATE_ID, Indexes.WORKFLOW_STATUS_IDX_WORKFLOW_STATUS_WORKFLOW_ID);
	}
	...
	public List<ForeignKey<WorkflowStatusRecord, ?>> getReferences() {
		return Arrays.asList(Keys.FK_WF_STATUS_WORKFLOW_ID, Keys.FK_WF_STATUS_WORKFLOW_STATE_ID, Keys.FK_WORKFLOW_STATUS_EVENT_FK, Keys.FK_WORKFLOW_STATUS_FIELD_FK, Keys.FK_WORKFLOW_STATUS_FORM_FK, Keys.FK_WORKFLOW_STATUS_ROBOT_FK, Keys.FK_WORKFLOW_STATUS_SCOPE_FK, Keys.FK_WORKFLOW_STATUS_USER_FK);
	}
	...
	public WorkflowPath workflow() {
		if (_workflow == null)
			_workflow = new WorkflowPath(this, Keys.FK_WF_STATUS_WORKFLOW_ID, null);
	...
	public WorkflowStatePath workflowState() {
		if (_workflowState == null)
			_workflowState = new WorkflowStatePath(this, Keys.FK_WF_STATUS_WORKFLOW_STATE_ID, null);
