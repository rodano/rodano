...
public class File extends TableImpl<FileRecord> {
	...
	/**
	 * The column <code>file.project_id</code>.
	 */
	public final TableField<FileRecord, java.util.UUID> PROJECT_ID = createField(DSL.name("project_id"), SQLDataType.UUID.nullable(false), this, "");
