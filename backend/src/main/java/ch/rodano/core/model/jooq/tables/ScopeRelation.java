...
public class ScopeRelation extends TableImpl<ScopeRelationRecord> {
	...
	/**
	 * The column <code>scope_relation.project_id</code>.
	 */
	public final TableField<ScopeRelationRecord, UUID> PROJECT_ID = createField(DSL.name("project_id"), SQLDataType.UUID.nullable(false), this, "");
