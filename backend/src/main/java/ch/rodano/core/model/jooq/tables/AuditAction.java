...
public class AuditAction extends TableImpl<AuditActionRecord> {
	...
	public List<Index> getIndexes() {
		return Arrays.asList(Indexes.AUDIT_ACTION_IDX_AUDIT_ACTION_PROJECT);
	}
	...
	public List<ForeignKey<AuditActionRecord, ?>> getReferences() {
		return Arrays.asList(Keys.FK_AUDIT_ACTION_PROJECT, Keys.FK_AUDIT_ACTION_ROBOT_FK, Keys.FK_AUDIT_ACTION_USER_FK);
	}
	...
	public ProjectPath project() {
		if (_project == null)
			_project = new ProjectPath(this, Keys.FK_AUDIT_ACTION_PROJECT, null);
	...
	public ProjectAuditPath projectAudit() {
		if (_projectAudit == null)
			_projectAudit = new ProjectAuditPath(this, null, Keys.FK_PROJECT_AUDIT_ACTION.getInverseKey());
