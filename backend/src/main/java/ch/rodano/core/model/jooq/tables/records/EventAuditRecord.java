...
public class EventAuditRecord extends UpdatableRecordImpl<EventAuditRecord> implements AuditRecord {
	...
	/**
	 * Setter for <code>event_audit.project_id</code>.
	 */
	...
	/**
	 * Getter for <code>event_audit.project_id</code>.
	 */
	 ...
	 */
	public EventAuditRecord(Long pk, UUID projectId, Long auditActionFk, ZonedDateTime auditDatetime, String auditActor, Long auditUserFk, Long auditRobotFk, String auditContext, Long auditObjectFk, String id, Boolean deleted, Long scopeFk, UUID scopeModelId, Integer eventGroupNumber, UUID eventModelId, ZonedDateTime expectedDate, ZonedDateTime date, ZonedDateTime endDate, Boolean notDone, Boolean blocking, Boolean locked) {
		super(EventAudit.EVENT_AUDIT);
