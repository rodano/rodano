...
public class Role extends TableImpl<RoleRecord> {
	...
	public List<Index> getIndexes() {
		return Arrays.asList(Indexes.ROLE_IDX_ROLE_PROFILE_ID, Indexes.ROLE_IDX_ROLE_SCOPE_FK);
	}
	...
	public List<ForeignKey<RoleRecord, ?>> getReferences() {
		return Arrays.asList(Keys.FK_ROLE_PROFILE_ID, Keys.FK_ROLE_ROBOT_FK, Keys.FK_ROLE_SCOPE_FK, Keys.FK_ROLE_USER_FK);
	}
	...
	public ProfilePath profile() {
		if (_profile == null)
			_profile = new ProfilePath(this, Keys.FK_ROLE_PROFILE_ID, null);
