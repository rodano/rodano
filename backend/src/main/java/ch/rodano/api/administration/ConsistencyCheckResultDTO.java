...
public record ConsistencyCheckResultDTO(
	...
	@Schema(description = "List of detected inconsistency messages; empty when consistent is true") @NotNull List<String> issues
) {

	public ConsistencyCheckResultDTO(final List<String> issues) {
