...
@Component({
	...
	templateUrl: './edit-password-policies-dialog.component.html',
	styleUrls: ['./edit-password-policies-dialog.component.css']
})
export class EditPasswordPoliciesDialogComponent {
	form: FormGroup;

	constructor(
		private fb: FormBuilder,
		private dialogRef: MatDialogRef<EditPasswordPoliciesDialogComponent>,
