...
@Component({
	...
	standalone: true,
	templateUrl: './edit-rule-tags-dialog.component.html',
	styleUrls: ['./edit-rule-tags-dialog.component.css'],
	imports: [
		CommonModule,
		MatDialogModule,
		MatIconModule,
...
export class EditRuleTagsDialogComponent implements OnInit {
	selectedTags: string[] = [];
	newTagInput = '';

	constructor(
		private dialogRef: MatDialogRef<EditRuleTagsDialogComponent>,
