...
@Component({
	...
	styleUrls: ['./edit-basic-info-dialog.component.css']
})
export class EditBasicInfoDialogComponent implements OnInit {
	form: FormGroup;
	...
	constructor(
		...
		private dialogRef: MatDialogRef<EditBasicInfoDialogComponent>,
