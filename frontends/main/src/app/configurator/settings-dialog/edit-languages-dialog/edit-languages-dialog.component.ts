...
@Component({
	...
	styleUrls: ['./edit-languages-dialog.component.css'],
	imports: [
		CommonModule,
		MatDialogModule,
		MatIconModule,
...
export class EditLanguagesDialogComponent implements OnInit {
	selectedLanguages: {code: string; name: string; isDefault: boolean}[] = [];

	constructor(
		private dialogRef: MatDialogRef<EditLanguagesDialogComponent>,
